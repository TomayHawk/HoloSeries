...
# buffer-healer
var default_level = 1
var default_max_health = 390 # +190 (+0.95 T1)
var default_max_mana = 2800 # +18 (+1.8 T1) ##### should be 26
var default_max_stamina = 1000 # #### should be 100
var default_defence = 10
var default_shield = 10
var default_strength = 10
var default_intelligence = 14 # +4 (+0.8 T1)
