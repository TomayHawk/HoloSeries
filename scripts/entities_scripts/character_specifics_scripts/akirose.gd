...
# physical-magic
var default_level = 1
var default_max_health = 396 # +196 (+0.98 T1)
var default_max_mana = 26 # +16 (+1.6 T1)
var default_max_stamina = 100
var default_defence = 11 # +1 (+0.2 T1)
var default_shield = 11 # +1 (+0.2 T1)
var default_strength = 14 # +4 (+0.8 T1)
...
var default_unlocked_nexus_nodes = [491, 522, 523]
