class_name Lootable extends RigidBody2D

var item_type: int = -1
var item_id: int = -1
var attraction: int = 1000
...
func instantiate_item(texture_path: String, area_scale: Vector2, id: int, attraction_strength: int, item_can_leave_attraction) -> void:
	$Sprite2D.texture = load(texture_path)
	$LootableArea2D.scale = area_scale
